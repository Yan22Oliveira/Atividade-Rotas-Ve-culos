...
class EditarVeiculosScreen extends StatefulWidget {

  final Veiculo veiculo;
  final Montadora montadora;
  EditarVeiculosScreen({required this.montadora, required this.veiculo});

  @override
  _EditarVeiculosScreenState createState() => _EditarVeiculosScreenState();
}

class _EditarVeiculosScreenState extends State<EditarVeiculosScreen> {
