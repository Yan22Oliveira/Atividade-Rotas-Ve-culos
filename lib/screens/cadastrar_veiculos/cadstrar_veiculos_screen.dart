...
class CadastrarVeiculosScreen extends StatefulWidget {

  final Montadora montadora;
  CadastrarVeiculosScreen({required this.montadora});

  @override
  _CadastrarVeiculosScreenState createState() => _CadastrarVeiculosScreenState();
}

class _CadastrarVeiculosScreenState extends State<CadastrarVeiculosScreen> {
